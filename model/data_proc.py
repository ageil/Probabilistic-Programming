...
def split_and_prep_data(p_data, t_data, s_data, r_data, y, p_types, p_stories, p_subreddits, train_frac=0.7):
    ...
    train_data = (p_data_train, y_train, p_types_train, p_stories_train, p_subreddits_train)
    test_data = (p_data_test, y_test, p_types_test, p_stories_test, p_subreddits_test)
